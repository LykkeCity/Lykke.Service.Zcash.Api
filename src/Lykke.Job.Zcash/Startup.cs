    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "Zcash.Job API");
                ...
                builder.RegisterModule(new JobModule(appSettings.Nested(x => x.ZcashApi), Log));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("Zcash.Job", ex => BlockchainErrorResponse.FromUnknownError(ex.ToString()), logClientErrors: true);
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "ZcashJobLog", consoleLogger),
                consoleLogger);
